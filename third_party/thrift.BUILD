# Minimal Apache Thrift C++ runtime for Aster RPC stubs.
#
# Builds the subset needed for generated types + service interfaces
# (binary protocol, buffer transports, processors, concurrent client sync).
